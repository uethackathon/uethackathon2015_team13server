...
public interface IConstants {
	 ...
	 */
	static final String MODEL_NAME_VIETNAMESE = "models/sentDetection/VietnameseSD.bin.gz";
	
	/**
	 * Training data for Vietnamese
	 */
	public static final String TRAINING_DATA_VIETNAMESE = "data/lang/vi/training.xml";
}
